...
import { Download, Video, Search, Clock, Car } from "lucide-react";
  ...
  return (
    <ClientSidebarLayout>
      <div className="max-w-[1600px] mx-auto px-4">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-800">Dash Cam</h1>
          <p className="text-gray-500">
            Dash cam footage uploaded by staff for your scheme.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          {loading ? (
            ...
            <div className="py-16 text-center text-gray-400">
              ...
              <p>No dash cam footage available.</p>
            </div>
          ) : (
