...
const BodyCamPage = () => {
  ...
  const videosQuery = useQuery({
    queryKey: ["clientBodyCamVideos", schemeId],
    queryFn: () => clientDataService.getBodyCamVideos(schemeId),
    enabled: !!schemeId,
  });

  useEffect(() => {
    if (videosQuery.isError) {
      console.error("Failed to load body cam videos:", videosQuery.error);
    }
