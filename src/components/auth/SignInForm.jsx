    ...
    const SignInForm = () => {
      ...
      return (
        <div className="w-full max-w-md p-6 sm:p-8 bg-white rounded-xl shadow-lg">
          <h2 className="text-gray-700 mb-1">Sign In</h2>
          <p className="text-sm text-gray-500 mb-6">
            Hello! Let's continue your work with <span className="font-semibold text-brand-500">LENSE.</span>
          </p>
          ...
          <form onSubmit={handleEmailSignIn} className="space-y-4">
            <div className="form-control">
              ...
              <input
                ...
                className="input input-lg w-full bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-teal-500 focus:border-teal-500 transition-all mb-2 pl-4 "
                required
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <input
                  ...
                  className="input input-lg w-full bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-teal-500 focus:border-teal-500 transition-all pl-4"
                  required
