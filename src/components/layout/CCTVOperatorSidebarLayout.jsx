...
import headerIcon from "../../assets/headerlogo.svg";
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className={`${collapsed ? 'w-16' : 'w-64'} bg-white shadow-lg flex flex-col transition-all duration-300 shrink-0`}>
        ...
        <div className="p-4 border-b flex items-center justify-between">
          ...
          {collapsed && (
            <Link to="/dashboard/cctvoperator" className="flex items-center justify-center w-full">
              <img src={headerIcon} alt="L" className="h-6 w-6 object-contain" />
            </Link>
          )}
          <button
