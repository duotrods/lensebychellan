              ...
              {loading && logs.length === 0 ? (
                <tr>
                  <td colSpan="5" className="px-6 py-12 text-center">
                    <FontAwesomeIcon icon={faRotateRight} className="w-8 h-8 text-gray-400 animate-spin mx-auto mb-2" />
                ...
                <tr>
                  <td colSpan="5" className="px-6 py-12 text-center">
                    <FontAwesomeIcon icon={faRightToBracket} className="w-12 h-12 text-gray-300 mx-auto mb-2" />
                ...
                logs.map((log) => {
                  const RoleIcon = ROLE_ICON[log.role] || faUser;
                  return (
                    <tr key={log.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium capitalize ${ROLE_BADGE[log.role] || "bg-gray-100 text-gray-700"}`}>
                          <FontAwesomeIcon icon={RoleIcon} className="w-3.5 h-3.5" />
                          {log.role}
                        </span>
                      </td>
